 ...
 *
 * Texture slots list candidates in order, best first; `textures.js` decides
 * which tier a body may have (2k always, 4k when selected, 8k when selected
 * on a GPU that can hold it) and takes the first file that exists within it.
 * The `8k_*` / `4k_*` / `2k_*` maps are Solar System Scope's (CC BY 4.0),
 * re-encoded to WebP; 4k and 2k live in the repository under its 2 MB budget,
 * 8k is generated by `scripts/convert-textures.py` and served from the deploy.
 * The older three.js maps stay as last fallbacks. Names are i18n keys under
 * `explore.bodies`.
 *
...
const T = '/textures/';
/** The 8k tier is served from outside the repository; see `.env.example`. */
...
export const BODIES = [
  {
    ...
    textures: { map: [`${H}8k_sun.webp`, `${T}4k_sun.webp`, `${T}2k_sun.webp`, `${T}sunmap.jpg`] },
  },
  {
    ...
    textures: { map: [`${H}8k_mercury.webp`, `${T}4k_mercury.webp`, `${T}2k_mercury.webp`, `${T}mercurymap.jpg`], bump: [`${T}mercurybump.jpg`] },
  },
  {
  ...
  },
  {
    ...
    textures: {
      map: [`${H}8k_earth_daymap.webp`, `${T}4k_earth_daymap.webp`, `${T}2k_earth_daymap.webp`, `${T}earth_atmos_2048.jpg`],
      night: [`${H}8k_earth_nightmap.webp`, `${T}4k_earth_nightmap.webp`, `${T}2k_earth_nightmap.webp`, `${T}earth_lights_2048.png`],
  ...
  },
  {
    ...
    textures: { map: [`${H}8k_mars.webp`, `${T}4k_mars.webp`, `${T}2k_mars.webp`, `${T}marsmap1k.jpg`], bump: [`${T}marsbump1k.jpg`] },
  },
  {
    ...
    textures: { map: [`${H}8k_jupiter.webp`, `${T}4k_jupiter.webp`, `${T}2k_jupiter.webp`, `${T}jupitermap.jpg`] },
  },
  {
    ...
    textures: { map: [`${H}8k_saturn.webp`, `${T}4k_saturn.webp`, `${T}2k_saturn.webp`, `${T}saturnmap.jpg`] },
  },
  {
 ...
 */
export const MOONS = [
  { id: 'moon', parent: 'earth', astro: 'Moon', radiusKm: 1737.4, massKg: 7.346e22, gravity: 1.62, tempC: -20, aKm: 384400, periodDays: 27.3217, color: '#b8b8b8', textures: { map: [`${H}8k_moon.webp`, `${T}4k_moon.webp`, `${T}2k_moon.webp`, `${T}moon_1024.jpg`] } },
